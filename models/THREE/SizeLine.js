 ...
 */
  ...
  function SizeLine({ l = 1000, w = 200, text ='', material = new THREE.LineBasicMaterial({ color: 0x319ff9, linewidth: 1 }) } = {}) {
    ...
    geom.addAttribute('position', new THREE.BufferAttribute( new Float32Array( [ 0, -.5, 0, 0, .5, 0 ] ), 3))

    var line = new THREE.Line(geom, material)
    this.add(line)

    geom = new THREE.BufferGeometry
    geom.addAttribute('position', new THREE.BufferAttribute( new Float32Array( [ 0, 0, -.5, 0, 0, .5 ] ), 3))
  ...
  SizeLine.prototype.addPoint = function(value) {
    ...
    var geom = new THREE.BufferGeometry
    geom.addAttribute('position', new THREE.BufferAttribute( new Float32Array( [ 0, 0, -.5, 0, 0, .5 ] ), 3))
    var mesh1 = new THREE.Line(geom, this.material)
